...
const REPLIT_URL = 'https://${process.env.EXPO_PUBLIC_DOMAIN}/api';

const LOCAL_PC_URL = "http://192.168.0.110:5000/api";

const BASE_URL = process.env.EXPO_PUBLIC_DOMAIN ? REPLIT_URL : LOCAL_PC_URL;
